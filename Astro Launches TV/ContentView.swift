...
// create a central timer shared by ConferenceRoomView OpsFloorView so their transitions are synchronized
var centralDisplayTimer =  Timer.publish(every: 15, on: .main, in: .common).autoconnect()
